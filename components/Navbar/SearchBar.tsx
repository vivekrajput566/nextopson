          ...
          {data.map((item, idx) => {
            return (
              <div
                ...
                className={`cursor-pointer text-[#555555] font-medium py-5 sm:text-sm text-xs md:text-base ${activeTab === item.name
        ...
        <div className='flex md:flex-row flex-col items-center md:justify-between  md:px-5 px-3'>
          ...
          <div className={' flex relative gap-3 items-center  2xl:w-[60%] md:w-[50%] w-[100%]  '}>
            ...
            {searchedTerm && (searchResults && !searchResults?.result) &&
              <div className='  absolute md:-left-7 -left-3 md:top-[42px] top-[100px] px-3 py-3 rounded-sm z-10 bg-white shadow-xl  md:w-[100%] sm:w-[105%] w-[108%] text-sm  '>
                {/* fbgfdgfdh */}
...
// Error: Cannot find module './undefined.webp'