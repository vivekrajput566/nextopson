...
<div className='md:w-[60%] w-[100%] flex flex-col justify-between gap-4 '>
  ...
  <div>
  <h3 className={`font-bold md:text-base text-sm`}>Premium Luxury First Floor</h3>
  <p className={`text-[#616874] md:text-base text-sm `}>3 BHK Independent Builder Floor in Uday Park, South Delhi</p>
    
  </div>
  <div className={`flex gap-10 items-center  `}>
    <div><h1 className='md:font-semibold font-bold md:text-xl text-lg'>2000</h1></div>
    <div className={`flex  gap-3 items-center `}>
      <h1 className='md:font-semibold font-bold md:text-xl text-lg'>3BHK</h1>
  ...
  onClick={()=>setIsContactDetails(true)}
   className={`sm:w-fit w-full text-primary border border-primary text-base font-semibold px-5 py-2 rounded-md`}>View Number</button>
  <button className={`sm:w-fit w-full flex gap-2 justify-center items-center text-white bg-primary border border-primary text-base font-semibold px-6 py-2 rounded-md`}><FaPhoneAlt /> <span>Contact</span></button>
